...
int main(int argc, char *argv[]) {
    ...
    if (argv[1]) {
        ...
        Tensor<int>* input_ids = new Tensor<int>(Device::GPU, type_int, {max_context_token_num},    d_input);
        Tensor<float>* output = new Tensor<float>(Device::GPU, type_float, {max_context_token_num,     hidden_size}, d_output);
        ...
        DataType type_int = getTensorType<int>();
        Tensor<int>* input_ids = new Tensor<int>(Device::GPU, type_int, {max_context_token_num},    d_input);
        Tensor<half>* output = new Tensor<half>(Device::GPU, type_half, {max_context_token_num,     hidden_size}, d_output);
